...
-- yanky
nmap_leader("y", "<Plug>(YankyYank)", "Yank text")
nmap_leader("p", "<Plug>(YankyPutAfter)", "Put yanked text after cursor")
nmap_leader("P", "<Plug>(YankyPutBefore)", "Put yanked text before cursor")
nmap_leader("gp", "<Plug>(YankyGPutAfter)", "Put yanked text after selection")
nmap_leader("gP", "<Plug>(YankyGPutBefore)", "Put yanked text before selection")
nmap_leader("<A-p>", "<Plug>(YankyPreviousEntry)", "Select previous entry through yank history")
nmap_leader("<A-n>", "<Plug>(YankyNextEntry)", "Select next entry through yank history")
nmap_leader("]p", "<Plug>(YankyPutIndentAfterLinewise)", "Put indented after cursor (linewise)")
nmap_leader("[p", "<Plug>(YankyPutIndentBeforeLinewise)", "Put indented before cursor (linewise)")
nmap_leader("]P", "<Plug>(YankyPutIndentAfterLinewise)", "Put indented after cursor (linewise)")
nmap_leader("[P", "<Plug>(YankyPutIndentBeforeLinewise)", "Put indented before cursor (linewise)")
nmap_leader(">p", "<Plug>(YankyPutIndentAfterShiftRight)", "Put after and indent right")
nmap_leader("<p", "<Plug>(YankyPutIndentAfterShiftLeft)", "Put after and indent left")
nmap_leader(">P", "<Plug>(YankyPutIndentBeforeShiftRight)", "Put before and indent right")
nmap_leader("<P", "<Plug>(YankyPutIndentBeforeShiftLeft)", "Put before and indent left")
nmap_leader("=p", "<Plug>(YankyPutAfterFilter)", "Put after applying a filter")
nmap_leader("=P", "<Plug>(YankyPutBeforeFilter)", "Put before applying a filter")
